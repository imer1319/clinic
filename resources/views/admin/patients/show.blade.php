...
<div class="row">
	...
	<div class="col-md-4">
		<div class="card">
			<div class="card-body">
				<div class="d-flex">
					<a href="" class="btn btn-primary btn-block" data-toggle="modal" data-target="#modal">Iniciar nueva consulta</a>
					<a id="showAgenda" class="btn btn-primary text-white cursor-pointer"><i class="fa fa-clock-o"></i></a>
				</div>
				<div class="showAgenda">
					<div class="card">
						<div class="card-body">
							...
							<div class="form-group">
								<input type="text" id="date_cita" class="form-control" placeholder="Selecciona la fecha">
			...
			<div class="card mt-2 pre-scrollable">
				...
				<form action="{{ route('admin.diaries.update', $diary) }}" method="POST">
					...
					<button type="submit" style="background: inherit; border: none; width: 100%; margin: 0;">
						<div class="mx-1 mt-1 mb-2 p-2 b-left-agenda border-consulta a_hover">
							<div class="row">
								...
								<div class="col-9 border-left d-flex flex-column">
	...
	<script>
		...
		$('#crearConsultaAgenda').click(function() {
			recolectarAgenda();
			// ajax
		});
