                ...
                <div class="card-body">
                    <div class="d-flex">
                        <a href="" class="btn btn-primary btn-block" data-toggle="modal" data-target="#modal">Iniciar
                            nueva consulta</a>
                        <a class="btn btn-primary text-white cursor-pointer" data-toggle="modal"
                            data-target="#modalAgenda"><i class="fa fa-clock-o"></i></a>
                    </div>
                    <div class="modal fade" id="modalAgenda" tabindex="-1" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Recervar en agenda</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
