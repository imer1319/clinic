                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <select class="form-control" name="morning_end[]">
                                                    @for ($i = 8; $i <= 12; $i++)
                                                        <option value="{{ ($i < 10 ? '0' : '') . $i }}:00"
                                                            @if ('0' . $i . ':00' == $horario->morning_end) selected @endif>
                                                            {{ $i }}:00 AM
                                                        </option>
                                                        <option value="{{ ($i < 10 ? '0' : '') . $i }}:30"
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <select class="form-control" name="afternoon_start[]">
                                                    @for ($i = 2; $i <= 6; $i++)
                                                        ...
                                                        <option value="{{ ($i < 10 ? '0' : '') . $i }}:30"
                                                            @if (($i < 10 ? '0' : '') . $i . ':30' == $horario->afternoon_start) selected @endif>
                                                            {{ $i }}:30 PM
                                                        </option>
                                                    @endfor
                                                </select>
                                            ...
                                            <div class="col">
                                                <select class="form-control" name="afternoon_end[]">
                                                    @for ($i = 2; $i <= 6; $i++)
                                                        <option value="{{ ($i < 10 ? '0' : '') . $i }}:00"
                                                            @if (($i < 10 ? '0' : '') . $i . ':00' == $horario->afternoon_end) selected @endif>
                                                            {{ $i }}:00 PM
                                                        </option>
                                                        <option value="{{ ($i < 10 ? '0' : '') . $i }}:30"
                                                            @if (($i < 10 ? '0' : '') . $i . ':30' == $horario->afternoon_end) selected @endif>
                                                            {{ $i }}:30 PM
                                                        </option>
                                                    @endfor
                                                </select>
