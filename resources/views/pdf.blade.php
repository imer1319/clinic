				...
				<td colspan="2">
					<table>
						<tr>
							...
							<td>
								Factura #: {{ $appointment->id }}<br />
								Creado: {{ $appointment->created_at->format('M d Y') }}<br />
								Hora: {{ $appointment->created_at->format('H:i') }}
							</td>
						</tr>
					</table>
				</td>
					...
					<table>
						<tr>
							...
							<td>
								...
								{{ $appointment->total - $appointment->total_debts !== 0 ? 'DEUDA' : 'PAGADO'}}
							</td>
						</tr>
					</table>
				</td>
